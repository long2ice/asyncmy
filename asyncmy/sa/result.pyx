...
cdef class ResultMetaData:
    ...
    def __cinit__(self, result_proxy: ResultProxy, metadata: MetaData):
        self._processors = []
        processors = []
    ...
    cdef _key_fallback(self, key: Union[str, expression.ColumnElement], raiseerr: bool = True):
        map = self._keymap
        result = None
...
cdef class ResultProxy:
    ...
    def __init__(self, connection: Connection, cursor: Cursor, dialect: Dialect, result_map):
