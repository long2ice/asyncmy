...
from asyncmy.sa.exc import InvalidRequestError, ArgumentError
...
try:
    ...
    raise ImportError('asyncmy.sa requires sqlalchemy')
...
def create_engine(minsize=1, maxsize=10,
...
class Engine:
    ...
    def __init__(self, dialect: Dialect, pool: Pool, compiled_cache: bool = None, **kwargs: dict):
